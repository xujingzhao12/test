...
public class VideoPlayView extends SurfaceView implements SurfaceHolder.Callback {
	...
	//private static final String strVideo11 = Environment.getExternalStorageDirectory().getPath() + "/h265.mp4";
	//视频路径
	private   String strVideo = "/storage/emulated/0/qqmusic/mv/T-ara - Love Suggestion (Live At 2013 Japan Tour Treasure B [mqms].mp4";
